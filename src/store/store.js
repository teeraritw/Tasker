...
const store = new Vuex.Store({
    state: {
        todos: [
            {
                title: 'Buy milk. Like many boxes of them. No seriously A LOT!',
                description: "Look at that text! Would anyone use that? Can you imagine that, the text of your next webpage?! You know, it really doesn’t matter what you write as long as you’ve got a young, and beautiful, piece of text. Despite the constant negative ipsum covfefe. Lorem Ipsum better hope that there are no \"tapes\" of our conversations before he starts leaking to the press!",
                author: 'Fester',
                date: new Date().toLocaleDateString()
            },
            {
                title: 'Play games',
                description: "I don't think anybody knows it was Russia that wrote Lorem Ipsum, but I don't know, maybe it was. It could be Russia, but it could also be China. It could also be lots of other people. It also could be some wordsmith sitting on their bed that weights 400 pounds. Ok?",
                author: 'Mitch',
                date: new Date().toLocaleDateString()
            },
            {
